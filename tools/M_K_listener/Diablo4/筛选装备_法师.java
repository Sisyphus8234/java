...
public class 筛选装备_法师 extends 筛选装备_子类 {
    ...
    public List<String> 需求词缀_目标() {
        return Arrays.asList( "攻击速度", "幸运一击几率", "暴击几率", "暴击伤害", "--点力量", "智力", "点智力", "--点敏捷", "--点意力", "点全属性",
                "核心技能伤害", "抗性", "伤害减免", "易伤伤害", "生命上限", "非物理伤害", "--距敌人的伤害", "法力", "冷却时间缩减", "敌人的伤害减免",
                "双持", "总护甲", "%伤害", "资源生成", "消耗", "--闪电伤害", "--电冲技能", "--连锁闪电", "寒冰碎片", "--电花", "寒霜技能", "冰霜伤害",
                "--冰霜球", "--爆焰", "--火焰", "--召唤", "--对燃烧", "--对冻伤", "移动速度");
    }

    @Override
    public List<String> 不要词缀_目标() {
        return Arrays.asList("受伤状态下的", "对受伤敌人的", "基础技能", "法力上限", "闪避获得", "闪电暴击伤害","对燃烧敌人的");
    }
...
//                当前装备情况.必须词缀_目标 = new String[]{"寒冰碎片", "暴击"};
                当前装备情况.装备种类 = 筛选装备.装备种类_枚举.筛选;
                当前装备情况.筛选哪些.add(筛选装备.筛选哪些_枚举.需求词缀);
                当前装备情况.筛选哪些.add(筛选装备.筛选哪些_枚举.必须词缀);
                break;
...
//                当前装备情况.必须词缀_目标 = new String[]{"冷却时间缩减","全属性"};
//                当前装备情况.必须词缀_减少量 = 1;
                当前装备情况.装备种类 = 筛选装备.装备种类_枚举.筛选;
                当前装备情况.筛选哪些.add(筛选装备.筛选哪些_枚举.需求词缀);
                当前装备情况.筛选哪些.add(筛选装备.筛选哪些_枚举.物品强度);
