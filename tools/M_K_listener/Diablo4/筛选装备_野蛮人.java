...
public class 筛选装备_野蛮人 extends 筛选装备_子类 {
    ...
    public String[] 需求词缀_目标() {
        return new String[]{ "移动速度","攻击速度", "暴击", "点力量","力量", "--点敏捷", "--点意力", "点全属性", "核心技能伤害", "抗性", "伤害减免", "--易伤伤害"
                , "生命上限", "物理伤害", "对近距敌人的伤害", "怒气上限", "对流血敌人的", "--敌人的伤害减免", "使用双手钝击武器的伤害","强固","总护甲","%伤害","--压制",
                "资源生成","狂暴","需要切换武器的","先祖之锤","冷却时间缩减"};
    }

    @Override
    public String[] 不要词缀_目标() {
        return new String[]{"--暗影抗性","--受伤状态下的伤害减免","对流血敌人的伤害减免", "对受伤敌人的暴击几率","闪避获得","你的药水也会","闪避的冷却时间","敌人的伤害减免"};
    }
...
//                当前装备情况.筛选哪些.add(筛选装备.筛选哪些_枚举.必须属性);
                ...
                当前装备情况.装备种类= 筛选装备.装备种类_枚举.筛选;
                当前装备情况.必须词缀_目标 = new String[]{"生命上限","总护甲"};
                当前装备情况.必须词缀_减少量 = 1;
                当前装备情况.筛选哪些.add(筛选装备.筛选哪些_枚举.必须词缀);
