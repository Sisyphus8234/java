...
//    }
    ...
    @ListenMouseKeyboard(value = 68 ,keyboardOrMouse = 0,intercept = true)
...
System.out.println("--------");
    ...
    @ListenMouseKeyboard(value = 68 ,keyboardOrMouse = 0,intercept = true,press = false)
    @ListenMouseKeyboard(value = 192 ,keyboardOrMouse = 0,intercept = true,press = false)
