...
public class 筛选装备_游侠 extends 筛选装备_子类 {
    ...
    @Override
    public List<String> 需求词缀_目标() {
        return Arrays.asList(new String[]{"攻击速度", "暴击几率", "暴击伤害","--点力量", "点敏捷", "敏捷","--点智力", "点全属性", "核心技能伤害", "抗性", "伤害减免", "易伤"
    ...
    @Override
    public List<String> 不要词缀_目标() {
        return Arrays.asList("受伤状态下的", "对受伤敌人的暴击几率", "被灌注技能的暴击伤害", "能量上限","对中毒敌人的伤害减免","暗影抗性","冰霜抗性");
    }

    @Override
    public List<String> 必须词缀_目标() {
