...
public class 筛选装备 {
    ...
    public static boolean 是否扫描 = false;
    public static boolean 是否筛选 = false;
    ...
    public static String savePicture(int x, int y, Robot robot) {
        ...
        try {
            ...
            fileName=folderName + "/" + outPictureName + LocalTime.now().format(DateTimeFormatter.ofPattern("HHmmss")) + ".png";
