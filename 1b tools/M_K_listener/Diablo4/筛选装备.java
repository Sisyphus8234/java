...
//                            筛选装备_子类.装备分类(extractedText, 筛选逻辑参数,预类别);
            ...
            if(当前装备情况.预类别==预类别.戒指){
                物品强度索引+=2;
            }else if(当前装备情况.预类别==预类别.护符){
                物品强度索引 += 1;
            }
            ...
            if (当前装备情况.装备种类.equals(装备种类.自定要求)) {
                筛选装备_子类.自定筛选(当前装备情况);
            } else {
                筛选逻辑(当前装备情况);
                ...
                }else if (当前装备情况.装备种类.equals(装备种类.不要)) {
                        当前装备情况.所有要求满足 = false;
                }else {
                    if (当前装备情况.数值优秀 || 当前装备情况.需求词条数量是否满足) {
                        当前装备情况.所有要求满足 = true;
        ...
        一件装备的所有文本.append("-----需求词条数量: ").append(当前装备情况.需求词条数量).append("\n");
        一件装备的所有文本.append("-----数值: ").append(当前装备情况.数值).append("\n");
        一件装备的所有文本.append("-----数值优秀: ").append(当前装备情况.数值优秀).append("\n");
